...
where (first_name IN ('Irena', 'Vidya', 'Maya')); #returns 709 or just look at the response line in action output

#3 Find all current or previous employees with first names 'Irena', 'Vidya', or 'Maya', as in Q2, but use OR instead of IN. Enter a comment with the number of records returned. Does it match number of rows from Q2? 
#using or the wrong way
select * from employees
...
select * from employees
where gender = 'M' and (first_name = 'Irena' or first_name = 'Vidya' or first_name = 'Maya'); #441
...
select * from employees
where last_name like '%e' and last_name not like 'e%'; #23393
...
#Method 1
select * from employees
where hire_date between '1990-01-01' and '1999-12-31'; #135,214
